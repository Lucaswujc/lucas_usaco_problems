...
public class DynamicRangeSumQueries {
	...
	long rangeSum(int start, int end) {
		return rangeSum(start, end, 1, 0, len - 1);
	}

	public DynamicRangeSumQueries(int len) {
		this.len = len;
		segtree = new long[len * 4];
	}

	public DynamicRangeSumQueries(long[] arr) {
		this.len = arr.length;
		segtree = new long[len * 4];
		build(arr, 1, 0, len - 1);
	}
	...
	public static void main(String[] args) {
		...
		DynamicRangeSumQueries segtree = new DynamicRangeSumQueries(arr);
