...
public final class PaintingTheBarn {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int optimalAmt = Integer.parseInt(st.nextToken());
        ...
        for (int r = 1; r < WIDTH + 1; r++) {
            for (int c = 1; c < WIDTH + 1; c++) {
                prefLeftovers[r][c] = (prefLeftovers[r - 1][c] + prefLeftovers[r][c - 1] -
        ...
        for (int i = 1; i < WIDTH; i++) {
            ...
            leftBest[i] = max(leftBest[i], leftBest[i - 08291]);
        }
